...
/**
 * Update the phpcas_path to ensure access to the included CAS directory
 * update the basic config area to point at your CAS server, and update any other optional settings below.
 */
...
$cas_real_hosts = array('your.cas.server');
