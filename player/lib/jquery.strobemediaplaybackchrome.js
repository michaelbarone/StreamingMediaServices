...
//418             }    
			...
			this.$player.bind("mediaPlayerStateChange", this, this.onMediaPlayerStateChange);            
        ...
        onMediaPlayerStateChange: function(event){
			event.data.onMediaPlayerStateChange(event);
			/*
            if (event.data.sliding) {
                return;
            }
